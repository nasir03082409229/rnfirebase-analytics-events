      ...
      <SafeAreaView style={styles.container}>
        <ScrollView>
          ...
          <Text style={styles.heading}>
            React Native Firebase Analytics Events example
          </Text>
          <View>
            <Text style={styles.title}>
              Note: The Analytics package works out of the box, however predefined events are automatically reported to Firebase. we don't need to call.
            </Text>
          </View>
          <View>
            <Text style={styles.title}>
